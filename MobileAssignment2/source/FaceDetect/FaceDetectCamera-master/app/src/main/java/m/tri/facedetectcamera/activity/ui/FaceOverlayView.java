        ...
        if (mFaces != null && mFaces.length > 0) {
            ...
            for (FaceResult face : mFaces) {
                ...
                if (mid.x != 0.0f && mid.y != 0.0f) {
                    ...
                    canvas.drawText("Smile Probability " + face.getConfidence(), rectF.left, rectF.bottom + mTextPaint.getTextSize() * 2, mTextPaint);
                    canvas.drawText("Eyes Distance " + face.eyesDistance(), rectF.left, rectF.bottom + mTextPaint.getTextSize() * 3, mTextPaint);
                }
            }
            canvas.restore();
        }
